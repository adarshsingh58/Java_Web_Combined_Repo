 ...
 * */
public class C_ProductionPrototype {

    /*
     * Prototype is NOT just cloning
     * Prototype is about:
     *  ✔ Copying without knowing concrete class
     *  ✔ Avoiding expensive creation
     *  ✔ Working with runtime-created objects
     *  ✔ Reducing dependency on constructors
     *
     * When NOT to use Prototype (important)
     * Do NOT use Prototype if:
     *  Object graph is huge and deep copying is complex
     *  Object creation is cheap
     *  Immutability already solves the problem
     *  Copy semantics are unclear
     *  If cloning is confusing → Prototype will amplify confusion.
     * */
    public static void main(String[] args) {
        Document invoice = new C_ProductionPrototype().new Document(
                "Invoice",
                "Invoice content...",
                Map.of("type", "FINANCE")
        );
        ...
        Document copyForReceipt = new C_ProductionPrototype().new Document(invoice);
